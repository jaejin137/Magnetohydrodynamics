C======================================================================C
c This part is to enforced nrbc in i direction at maximum index side.  c
C======================================================================C
clist(1)
      subroutine sr_nri(jq, kq, il, jl, kl, nl, x, y, z,
     $                  ilower, iupper, jlower, jupper, klower, kupper,
     $                  gamma, q, bm, poutlet, mx2, sigma)
c
...
c
   ...
   10 continue
c
c ... compute metrics ( at max i boundary )
c
      i = il
      ip = i + 1
      xxi = x(ip,j,k) -x(i,j,k) +x(ip,jp,k) -x(i,jp,k)+
...
c
      call gdout(gamma, xix, xiy, xiz, jcb, bxi, pv, pvpxi,
     >           alf, poutlet, mx2, sigma, xli, plpv, dxi)
c
c ... d matrix
c
      bm(1) = dxi(1)
...
C======================================================================C
clist(2)
      subroutine sl_nri(jq, kq, il, jl, kl, nl, x, y, z,
     $                  ilower, iupper, jlower, jupper, klower, kupper,
...
c
   ...
   10 continue
c
c ... compute metrics ( at outlet boundary )
c
      i = il
      ip = i + 1
      xxi = x(ip,j,k) -x(i,j,k) +x(ip,jp,k) -x(i,jp,k)+
...
C======================================================================C
clist(3)
      subroutine gdout(gamma, xix, xiy, xiz, jcb, bxi, pv, pvpxi,
     >                 alf, poutlet, mx2, sigma, xli, plpv, dxi)
c
c This subroutine is used to calculate vector d for outflow.
c
      implicit none
c
c *** INTERFACE VARIABLES
...
c ... calculate italic Ls
c
      cf0 = sigma(2)*dabs( 1.d0-mx2 )
      ck = cf0/rr/1.4142136d0
      xli(5) = ck*dpc
c
c ... compute pl/pv
c
...
C======================================================================C
clist(4)
      subroutine mxmach(il, jl, kl, nl, x, y, z,
     $                  ilower, iupper, jlower, jupper, klower, kupper,
     $                  gamma, q, mx2)
c
c     This subroutine is used to calculate maximum Mach number in 
c     entire computational domain and average pressure at downstream
c     side.
c
      implicit none
c
